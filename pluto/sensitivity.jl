...
# ╔═╡ b625cdf8-5096-11ed-0898-3122ccd9ba59
using JuMP

# ╔═╡ cb47c846-a7aa-4b8d-8e19-bfb8464194c9
using GLPK

# ╔═╡ 4d2cbcf4-6d34-416d-bcb7-a2d60166e762
...
# ╔═╡ 99fc87f3-83be-44a6-972d-9cce6687724a
begin
	m = Model(GLPK.Optimizer)
	@variable(m, x)
	@variable(m, y)
	@objective(m, Max, 3x + 4y)
	@constraint(m, c1, 5x + 4y <= b1)
	@constraint(m, c2, 6x + 12y <= b2)
	@constraint(m, [x, y] .>= 0)
	optimize!(m)
	xval = value(x)
	yval = value(y)
